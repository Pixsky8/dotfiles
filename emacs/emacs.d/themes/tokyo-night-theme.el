 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'tokyo-night
	...
	`(org-hide ((,class (:foreground ,fg4))))
        `(org-level-1 ((,class (:bold t :foreground ,"DodgerBlue1" :height 1.1))))
        `(org-level-2 ((,class (:bold nil :foreground ,"sienna1"))))
        `(org-level-3 ((,class (:bold t :foreground ,"DarkOliveGreen3"))))
        ...
        `(org-todo ((,class (:box (:line-width 1 :color ,fg3) :foreground ,"#ee3b3b" :bold t))))
	...
	`(info-string ((,class (:foreground ,str))))
        ...
        `(magit-diff-context-highlight ((,class (:background ,bg3 :foreground ,"black"))))
